...
> 组别：卡丁快跑组
> 奖项：全国一等奖
> 主控：Infineon AURIX TC387（TriCore 三核 @ 300MHz）
...
├── fatfs/       FATFS 文件系统
├── guimai/      硅麦语音识别链路（EVADC+DMA 16kHz PCM 采集）
├── IMU/         地磁传感器驱动（dici）
├── led_strip/   LED 灯带驱动
...
- **语音识别**：硅麦模拟信号经 EVADC 组0 定时采样 + DMA 搬运至环形缓冲，软件直流滤波后送识别链路
