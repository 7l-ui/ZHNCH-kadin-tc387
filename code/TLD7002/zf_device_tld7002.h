...
#define TLD7002_GPIN0_PIN       (P10_3)             // GPIN0引脚定义
#define TLD7002_DIAG_OK                 (0x00000000UL)
#define TLD7002_DIAG_OTP_EMU_FAIL       (0x00000001UL)
#define TLD7002_DIAG_INIT_FAIL          (0x00000002UL)
#define TLD7002_DIAG_DUTY_FAIL          (0x00000004UL)
#define TLD7002_DIAG_VLED_FAIL          (0x00000008UL)
#define TLD7002_DIAG_DTS_FAIL           (0x00000010UL)
