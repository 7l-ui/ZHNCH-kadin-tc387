...
#define DOT_MATRIX_SCREEN_SR4_PIN       (P14_6)
#define DOT_MATRIX_SCREEN_SR5_PIN       (P14_5)
#define DOT_MATRIX_SCREEN_SR6_PIN       (P14_4)

#define DOT_MATRIX_SCREEN_ROW_NUM       (7)
#define DOT_MATRIX_SCREEN_COL_NUM       (15)
#define DOT_MATRIX_SCREEN_BITMAP_MASK   (0x7FFFU)

typedef enum
{
    DOT_MATRIX_SCREEN_PATTERN_BLANK = 0,
    ...
    DOT_MATRIX_SCREEN_PATTERN_WIPER,
    DOT_MATRIX_SCREEN_PATTERN_HORN,
    DOT_MATRIX_SCREEN_PATTERN_BRAKE,
    DOT_MATRIX_SCREEN_PATTERN_REVERSE,
    DOT_MATRIX_SCREEN_PATTERN_ALL_ON,
    DOT_MATRIX_SCREEN_PATTERN_COUNT
} dot_matrix_screen_pattern_enum;

#define DOT_MATRIX_SCREEN_PATTERN_HAZARD DOT_MATRIX_SCREEN_PATTERN_DOUBLE_FLASH
