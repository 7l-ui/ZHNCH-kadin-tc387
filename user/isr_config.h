...
//================================================PIT中断参数相关定义===============================================
#define CCU6_0_CH0_INT_SERVICE  IfxSrc_Tos_cpu3     // 定义CCU6_0 PIT通道0中断服务类型，即中断是由谁响应处理 IfxSrc_Tos_cpu0 IfxSrc_Tos_cpu1 IfxSrc_Tos_cpu2 IfxSrc_Tos_cpu3 IfxSrc_Tos_dma  不可设置为其他值
...
#define UART19_INT_SERVICE       IfxSrc_Tos_cpu0
#define UART19_TX_INT_PRIO       43
#define UART19_RX_INT_PRIO       44
#define UART19_ER_INT_PRIO       45
...
#define UART19_INT_VECTAB_NUM        (int)UART19_INT_SERVICE          > 0 ? (int)UART19_INT_SERVICE        - 1 : (int)UART19_INT_SERVICE
