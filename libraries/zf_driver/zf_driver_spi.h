...
typedef enum                                                                                                                // 枚举SPI CLK引脚 此枚举定义不允许用户修改
{
    ...
    SPI1_SCLK_P10_2  = 1*102+0*6 , SPI1_SCLK_P11_6,              //8388                                                          // SPI1 CLK 引脚可选范围

    SPI2_SCLK_P13_0  = 2*102+0*6 , SPI2_SCLK_P13_1, SPI2_SCLK_P15_3, SPI2_SCLK_P15_6, SPI2_SCLK_P15_8,    //9555，屏幕，gps，2x5  // SPI2 CLK 引脚可选范围

    SPI3_SCLK_P02_7  = 3*102+0*6 , SPI3_SCLK_P01_7,                                                                         // SPI3 CLK 引脚可选范围

    SPI4_SCLK_P22_0  = 4*102+0*6 , SPI4_SCLK_P22_1, SPI4_SCLK_P22_3, SPI4_SCLK_P33_11,                 //2x5，2x5，舵机     // SPI4 CLK 引脚可选范围
}spi_sck_pin_enum;
