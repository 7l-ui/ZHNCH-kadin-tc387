...
#define SCC8660_SCCB_INIT_RETRY_COUNT       (3U)
#define SCC8660_SCCB_INIT_RETRY_DELAY_MS    (80U)
//================================================定义 SCC8660 基本配置================================================

//================================================定义 SCC8660 参数配置（仅支持凌瞳高帧率版本）===========================
#define SCC8660_W               (160)                                           // 图像宽度 可选参数为：160 80  40
#define SCC8660_H               (160)                                           // 图像高度 可选参数为：120 160 240
...
#define SCC8660_BRIGHT_DEF      (110)                                           // 亮度设置     手动曝光默认：300   手动曝光时：参数范围0-65535   自动曝光推荐值：100 自动曝光时参数设置范围0-255
...
#define SCC8660_MANUAL_WB_DEF   (0x00)                                          // 手动白平衡   默认：0         可选参数为：[0,0x65-0xa0] 0：关闭手动白平衡，启用自动白平衡    其他：手动白平衡 手动白平衡时 参数范围0x65-0xa0
//================================================定义 SCC8660 参数配置（仅支持凌瞳高帧率版本）===========================
